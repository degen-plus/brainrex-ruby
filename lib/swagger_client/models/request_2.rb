...
module SwaggerClient
  class Request2
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'orient')
        self.orient = attributes[:'orient']
      end

      if attributes.has_key?(:'candle_size')
        self.candle_size = attributes[:'candle_size']
      end
    ...
    def hash
      [exchange, market, data_format, orient, candle_size, start_date, end_date].hash
    end
